...
public class MovieRecommend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText("Recommended Movies are: ");

        Adapter adapter=new Adapter(this,movie);
        ...
        String movie = sharedPreferences.getString(ourEmo, null);
...
//        Toast.makeText(getApplicationContext(), movie , Toast.LENGTH_SHORT).show();
    ...
    void connectServer(String movie){

//        https://www.myawesomesite.com/turtles/types?type=1&sort=relevance#section-name
        Uri.Builder builder = new Uri.Builder();
        builder.scheme("http")
                .authority("b2166ac6caad.ngrok.io")
                .appendQueryParameter("movie", movie);
...
//                                Toast.makeText(getApplicationContext(), res, Toast.LENGTH_SHORT).show();
    ...
    private void displayMovies(String res) {
